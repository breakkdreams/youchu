<?php
	...
	if ($ok == 1) { 
		switch($_REQUEST[payResult]){
				case '10':
						payOrderState($_REQUEST[orderId]);
						//此处做商户逻辑处理
						$rtnOK=1;
						//以下是我们快钱设置的show页面，商户需要自己定义该页面。
						$rtnUrl="http://www.0573dl.com/show.php?msg=success";
						break;
				default:
						$rtnOK=1;
						//以下是我们快钱设置的show页面，商户需要自己定义该页面。
						$rtnUrl="http://www.0573dl.com/show.php?msg=false";
						break;	
						...
						$rtnOK=1;
						//以下是我们快钱设置的show页面，商户需要自己定义该页面。
						$rtnUrl="http://www.0573dl.com/show.php?msg=error";
