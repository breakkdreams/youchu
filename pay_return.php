<?php 
	...
	if($verify_result) {//验证成功
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//请在这里加上商户的业务逻辑程序代码
		$sql = "update shop_order set pay_time=now() where order_code='$out_trade_no'";
		
		$back_r = SQLHelper::getInstance()->execute($sql);
	...
	if(!empty($_SESSION['_shop_login_id'])){
		...
		$smarty->display('core/templates/pay_return.tpl',md5($_SERVER["REQUEST_URI"]));	
	}else{
