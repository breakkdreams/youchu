...
<div class="row-fluid">
    ...
    <button class="btn btn-primary" onclick="window.location.href='menu_list.php';"><i class="icon-plus"></i>返回列表</button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    ...
    <table cellpadding="0" cellspacing="0" style="width:100%;line-height: 35px;" border="0">
        <tr style="display: none;">
        	...
        	<td class="td1">
        		<select name="slt" id="slt" style="width:222px;" onchange="javascript:selectFid(this.value)">
        			...
        			<option value="0|0|0" selected="selected">一级分类</option>
        ...
        <tr>
        	...
        	<td class="td1">
        		<input type="text" name="m_order" id="m_order" value="{$map['m_order']}" class="ipt1"/>&nbsp;<span class="left_txt">数字越小越靠前</span>
        	</td>
        </tr>
        <tr>
        	<td align="right" class="td1"><span class="td1_bt">栏目链接:</span>&nbsp;</td>
        	<td class="td1">
