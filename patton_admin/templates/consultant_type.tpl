...
<div class="row-fluid">
    ...
    <button class="btn btn-primary" onclick="window.location.href='consultant_type_create.php';"><i class="icon-plus"></i>添加类别</button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    <table class="table">
      ...
      <tbody>
        ...
        {/if}
          ...
          <td>{$item['c_name']}</td>
          <td>
              <a href="consultant_type_create.php?id={$item['c_id']}" title="编辑"><i class="icon-pencil"></i></a>
              &nbsp;
