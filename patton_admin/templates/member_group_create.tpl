...
<div class="well">
    <form method="post" action="?" onsubmit="return check();" style="margin: 0px;">
     <table cellpadding="0" cellspacing="0" style="width:100%;line-height: 35px;font-size:14px;" border="0">
        <tr>
        	<td align="right" style="width:128px;" class="td1"><span class="td1_bt">会员分组:</span>&nbsp;</td>
        	<td class="td1">
        	<input type="text" name="group_name" id="group_name" value="{$map['group_name']}" style="height:28px;line-height: 28px;"/>&nbsp;
        	<span class="left_txt">* 例如：企业会员、一般会员</span>
        	</td>
        </tr>
        <tr>
        	<td align="right" class="td1"><span class="td1_bt">简短描述:</span>&nbsp;</td>
        	<td class="td1">
        		<input type="text" name="group_describe" id="group_describe" value="{$map['group_describe']}" style="height:28px;line-height: 28px;width:670px;"/>&nbsp;
        	</td>
        </tr>
        ...
        <tr>
        	...
        	<td>&nbsp;
        		...
        		{/if}
        		<input type="hidden" name="group_id" value="{$map['group_id']}"/>
