...
<div class="row-fluid">
    ...
    <button class="btn btn-primary" onclick="window.location.href='sku.php'"><i class="icon-plus"></i>返回列表</button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    <form method="post" action="?" onsubmit="return check();" style="margin: 0px;">
     <table cellpadding="0" cellspacing="0" style="width:100%;line-height: 35px;font-size:14px;" border="0">
        <tr>
        	<td align="right" style="width:128px;" class="td1"><span class="td1_bt">SKU名称:</span>&nbsp;</td>
        	<td class="td1">
        	<input type="text" name="sku_name" id="sku_name" value="{$map['sku_name']}" style="height:28px;line-height: 28px;"/>&nbsp;
        ...
        <tr>
        	...
        	<td>&nbsp;
        		...
        		{/if}
        		<input type="hidden" name="sku_id" value="{$map['sku_id']}"/>
