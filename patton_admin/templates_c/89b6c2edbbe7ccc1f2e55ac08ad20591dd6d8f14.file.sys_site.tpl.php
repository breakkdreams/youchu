<?php /* Smarty version Smarty-3.1.14, created on 2017-04-20 10:12:48
         compiled from "templates\sys_site.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2155858f81920ab09e1-68342347%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '89b6c2edbbe7ccc1f2e55ac08ad20591dd6d8f14' => 
    array (
      0 => 'templates\\sys_site.tpl',
      1 => 1451889538,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2155858f81920ab09e1-68342347',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58f81920c0ff60_76383184',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58f81920c0ff60_76383184')) {function content_58f81920c0ff60_76383184($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
  <head>
...
<div id="woaicss_con1" style="display:block;">
   ...
   <table cellpadding="0" cellspacing="0" style="width:100%;line-height: 35px;font-size:14px;" border="0">
        <tr>
        	...
        	<td class="td1">
        		<input type="text" name="b_website" id="b_website" value="<?php echo $_smarty_tpl->tpl_vars['map']->value['b_website'];?>
" class="input1"/>&nbsp;
        ...
        <tr>
        	...
        	<td class="td1">
        	<input type="text" name="b_title" id="b_title" value="<?php echo $_smarty_tpl->tpl_vars['map']->value['b_title'];?>
" class="input1"/>&nbsp;
        ...
        <tr>
        	...
        	<td class="td1">
        		<input type="text" name="b_keyword" id="b_keyword" value="<?php echo $_smarty_tpl->tpl_vars['map']->value['b_keyword'];?>
" class="input1"/>&nbsp;
        ...
        <tr>
        	...
        	<td class="td1">
        		<input type="text" name="b_describe" id="b_describe" value="<?php echo $_smarty_tpl->tpl_vars['map']->value['b_describe'];?>
" class="input1"/>&nbsp;
        ...
        <tr>
        	...
        	<td class="td1">
        		<input type="text" name="b_www" id="b_www" value="<?php echo $_smarty_tpl->tpl_vars['map']->value['b_www'];?>
" class="input1"/>&nbsp;
        ...
        <tr>
        	...
        	<td class="td1">
        		<input type="text" name="b_number" id="b_number" value="<?php echo $_smarty_tpl->tpl_vars['map']->value['b_number'];?>
" class="input1"/>&nbsp;
 ...
 <div id="woaicss_con2" style="display:none;">
   <table cellpadding="0" cellspacing="0" style="width:100%;line-height: 35px;font-size:14px;" border="0">
        <tr>
        	...
        	<td class="td1">
        		<input type="text" name="b_company" id="b_company" value="<?php echo $_smarty_tpl->tpl_vars['map']->value['b_company'];?>
" class="input1"/>&nbsp;
        ...
        <tr>
        	...
        	<td class="td1">
        	<input type="text" name="b_address" id="b_address" value="<?php echo $_smarty_tpl->tpl_vars['map']->value['b_address'];?>
" class="input1"/>&nbsp;
        ...
        <tr>
        	...
        	<td class="td1">
        		<input type="text" name="b_tel" id="b_tel" value="<?php echo $_smarty_tpl->tpl_vars['map']->value['b_tel'];?>
" class="input1"/>&nbsp;
...
" class="input1"/>&nbsp;
        ...
        <tr>
        	...
        	<td class="td1">
        		<input type="text" name="b_email" id="b_email" value="<?php echo $_smarty_tpl->tpl_vars['map']->value['b_email'];?>
" class="input1"/>&nbsp;
   ...
   <table cellpadding="0" cellspacing="0" style="width:100%;line-height: 35px;font-size:14px;" border="0">
        <tr>
        	<td align="right" style="width:25px;" class="td1">
        		<div id="d_content" style="display:none"><?php echo $_smarty_tpl->tpl_vars['map']->value['b_info'];?>
</div>
        	</td>
        	<td class="td1">
        		<script id="editor" type="text/plain" style="min-width:700px;max-width:800px;height:500px;"><?php echo $_smarty_tpl->tpl_vars['map']->value['b_info'];?>
</script>
        		<input type="hidden" name="b_info" id="b_info"/>
        		<input type="hidden" name="cmd" value="create"/>
        		<input type="hidden" name="b_id" id="b_id" value="<?php echo $_smarty_tpl->tpl_vars['map']->value['b_id'];?>
"/>
			</td>
        </tr>
        </table>
