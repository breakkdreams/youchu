    ...
    <table class="table">
      ...
      <tbody>
        ...
        {/if}
          ...
          <td>
              <a href="purchase_list.php?product_id={$item['product_id']}" title="进货管理">进货管理</a>
              &nbsp;
              <a href="product_create.php?id={$item['product_id']}&type=list&page={$page}&productName={$product_name}" title="编辑"><i class="icon-pencil"></i></a>
              &nbsp;
