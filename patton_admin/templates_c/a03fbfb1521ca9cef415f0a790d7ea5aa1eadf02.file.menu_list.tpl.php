<?php /* Smarty version Smarty-3.1.14, created on 2017-04-20 10:08:15
         compiled from "templates\menu_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1225958f8180fd68ec7-47761745%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a03fbfb1521ca9cef415f0a790d7ea5aa1eadf02' => 
    array (
      0 => 'templates\\menu_list.tpl',
      1 => 1451627883,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1225958f8180fd68ec7-47761745',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58f8181002cc31_04603292',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58f8181002cc31_04603292')) {function content_58f8181002cc31_04603292($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
  <head>
...
<div class="row-fluid">
    ...
    <button class="btn btn-primary" onclick="window.location.href='menu_create.php';"><i class="icon-plus"></i>添加栏目</button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
...
?>
        <tr>
          ...
          <td><?php echo $_smarty_tpl->tpl_vars['item']->value['m_url'];?>
</td>
...
" target="_blank">查看</a><?php }?></td>
          <td>
          	  <!-- <a href="menu_create.php?parent_id=<?php echo $_smarty_tpl->tpl_vars['item']->value['m_id'];?>
" title="添加子栏目">添加子栏目</i></a> -->
          	  &nbsp;
              <a href="menu_create.php?id=<?php echo $_smarty_tpl->tpl_vars['item']->value['m_id'];?>
